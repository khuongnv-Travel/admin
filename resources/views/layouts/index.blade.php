...
<head>
	...
	{{-- <script type="text/javascript" src="{{ url(mix('assets/js/app.min.js')) }}"></script> --}}
	...
	<!-- Icons Css -->
	<!-- <link href="css/boxicons/css/boxicons.min.css" rel="stylesheet" type="text/css"> -->
	<!-- App Css-->
					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
							<a href="calendar.html" class=" waves-effect">
								<i class="bx bx-calendar-outline"></i>
								<span>Calendar</span>
							</a>
						</li>
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect">
								<i class="bx bx-page-layout-header"></i>
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect">
								<i class="bx bx-account-circle-outline"></i>
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect">
								<i class="bx bx-format-page-break"></i>
								<span>Utility</span>
							</a>
							<ul class="sub-menu" aria-expanded="false">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect">
								<i class="bx bx-briefcase-variant-outline"></i>
