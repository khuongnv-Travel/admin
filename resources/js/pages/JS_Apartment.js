...
JS_Apartment.prototype.loadEvent = function(){
    var myClass = this;
    $("#provinces").change(function(){
        myClass.changeProvince();
    });
    $("#districts").change(function(){
        myClass.changeDistrict();
    });
...
/**
 * Thay đổi danh mục Quận huyện
 */
JS_Apartment.prototype.changeProvince = function(){
    var myClass = this;
    var url = myClass.baseUrl + '/changeProvince';
    var data = {
        _token: $("#_token").val(),
...
/**
 * Thay đổi danh mục Phường xã
 */
JS_Apartment.prototype.changeDistrict = function(){
    var myClass = this;
    var url = myClass.baseUrl + '/changeDistrict';
    var data = {
        _token: $("#_token").val(),
