...
(function(a) {
    function f(b) {
        ...
        c = '<div id="' + g + '" class="border-' + brd + ' toast ' + v + '" role="alert" aria-live="assertive" aria-atomic="true" ' + p + " " + q + '><div class="d-flex justify-content-between toast-header ' + (e + " " + c + '">');
